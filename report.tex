...
Comparing the different languages now shows a significant difference in the models accuracy to predict titles from german, french and italian literature. Figure \ref{fig:language_chart} illustrates the zero-shot evaluation results. While none of the results appear to be especially bad, there is a visible gap between them and the english accuracy. Dutch scored higher than we expected. As Italian and Dutch are the two smallest of the datasets we chose, italian having 1010 books included and dutch 1420, this may be an interesting find of smaller booksets maybe being better stored in the models and easier to reproduce. Another possible interpretation could be that the books from this languages are more famous ones. While in Project Guttenberg all kinds of books can be saved this means that for english literature also very niche texts are stored. For less represented languages this could instead leading to only being represented by their most famous literature. 
